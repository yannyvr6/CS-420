...
<video src="https://github.com/microsoft/vscode-copilot-chat/raw/HEAD/images/1_102/edit-previous-requests.mp4" title="Video showing the process of editing a previous request in the Chat view." autoplay loop controls muted></video>
...
<video src="https://github.com/microsoft/vscode-copilot-chat/raw/HEAD/images/1_102/terminal-auto-approve.mp4" title="Video showing terminal commands like 'echo' and 'ls' being auto-approved in the Chat view." autoplay loop controls muted></video>
...
<video src="https://github.com/microsoft/vscode-copilot-chat/raw/HEAD/images/1_102/auxmax.mp4" title="Video showing maximizing the Secondary Side Bar." autoplay loop controls muted></video>
...
![Screenshot of the VS Code dock icon showing an agent confirmation as a badge.](https://github.com/microsoft/vscode-copilot-chat/raw/HEAD/images/1_102/badge.png)
...
<video src="https://github.com/microsoft/vscode-copilot-chat/raw/HEAD/images/1_102/chatcli.mp4" title="Video showing the Chat CLI in action to open the Chat view from the command line and run a prompt." autoplay loop controls muted></video>
...
<video src="https://github.com/microsoft/vscode-copilot-chat/raw/HEAD/images/1_102/mcp-server-elicit.mp4" autoplay loop controls muted></video>
...
<video src="https://github.com/microsoft/vscode-copilot-chat/raw/HEAD/images/1_102/mcp-servers-discovery-install.mp4" title="Video showing installing an MCP server from the MCP page on the VS Code website." autoplay loop controls muted></video>
...
<video src="https://github.com/microsoft/vscode-copilot-chat/raw/HEAD/images/1_102/settings-search-toggle-stable.mp4" title="Switching between AI and non-AI results using the AI results toggle in the Settings editor" autoplay loop controls muted></video>
...
You can check out all of GitHub Copilot's [preview features](https://github.com/microsoft/vscode-copilot-chat/blob/HEAD/command:workbench.action.openSettings?%5B%22%40tag%3Apreview%20%40ext%3Agithub.copilot-chat%22%5D) using `@tag:preview` in the Settings editor and all of the [experimental features](https://github.com/microsoft/vscode-copilot-chat/blob/HEAD/command:workbench.action.openSettings?%5B%22%40tag%3Aexperimental%20%40ext%3Agithub.copilot-chat%22%5D) using `@tag:experimental`.
